			...
			<section className={styles.main_why}>
				<article className={styles.main_why_block}>
					<h2 className={styles.main_why_block_title}>
						Интернет-магазин тканей для шитья, для дома и рукоделия &quot;Твои
						ткани&quot; приглашает за покупками.
					</h2>
					<p className={styles.main_why_block_text}>
						Ищете надежный магазин натуральных тканей с широким ассортиментом?
						Вы попали по адресу! У нас Вы найдете то, что Вам нужно.
					</p>
					<p className={styles.main_why_block_text}>
						Ищете надежный магазин натуральных тканей с широким ассортиментом?
						Вы попали по адресу! У нас Вы найдете то, что Вам нужно.
				...
				<article className={styles.main_why_block}>
					...
					<p className={styles.main_why_block_text}>
						У нас Вы можете купить хлопковые и смесовые ткани для детей и
						взрослых по доступным ценам. Сатин, бязь, поплин, плюш, велюр и
						другие ткани.
					</p>
				</article>
				<article className={styles.main_why_block}>
